    ...
    return (
        <section className={`wpo-Service-section section-padding ${props.pbClass}`}>
            <div className="container ff">
                <SectionTitle MainTitle={'Ablauf'} subTitle={''} />
                        ...
                        <div key={index} className="faq-item">
                            <div className="faq-question" onClick={() => toggleAccordion(index)} style={{cursor:"pointer"}}>
                                <div style={{display: "flex", alignItems: "center"}}>
                                    ...
                                    <h3 style={{fontWeight: "bold", fontFamily:"Montserrat", marginLeft:"auto"}}>{item.question}<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(184,147,57,1)"><path d="M12 16L6 10H18L12 16Z"></path></svg></h3>
                                </div>
                                <hr/><br/>
                            </div>
                            {activeIndex === index && (
