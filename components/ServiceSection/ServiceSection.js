                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12" key={sitem}>
                                <div className="wpo-Service-item">
                                    ...
                                    <div className="wpo-Service-text text-wrap">
                                        <h2 style={{fontFamily:"Montserrat", fontSize:"22px", cursor:"pointer", fontWeight:"600", marginTop:"10px"}} onClick={() => handlePriceClick(service.price)}>{service.price} €</h2>
                                    </div>
                                </div>
                        ...
                        {VServices.map((vservice, vsitem) => (
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12" key={vsitem}>
                                <div className="wpo-Service-item">
                                    ...
                                    <div className="wpo-Service-text text-wrap">
                                        <h2 style={{fontFamily:"Montserrat", fontSize:"20px", cursor:"pointer", fontWeight:"600", marginTop:"10px"}} onClick={() => handlePriceClick(vservice.price)}>{vservice.price} €</h2>
                                    </div>
                                </div>
                                <div className="wpo-Service-item item-service">
                                    <ul className="list-item">
                        ...
                        {OServices.map((oservice, ositem) => (
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12" key={ositem}>
                                <div className="wpo-Service-item">
                                    ...
                                    <div className="wpo-Service-text text-wrap">
                                        <h2 style={{fontFamily:"Montserrat", fontSize:"22px", cursor:"pointer", fontWeight:"600", marginTop:"10px"}} onClick={() => handlePriceClick(oservice.price)}>{oservice.price} €</h2>
                                    </div>
                                </div>
                                <div className="wpo-Service-item item-service">
                                    <ul className="list-item">
