                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className="copyright">
                                <p>© Copyright 2024 | THEPLUG WEDDING - All rights reserved | <Link href="/Impressum">Impressum</Link> | <Link href="/Impressum">Impressum</Link> | Web Designed By <Link style={{color:'#B99226', fontWeight: 'bold'}} href="https://www.comtheplug.com/" target='_blank'>THEPLUG COM</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
